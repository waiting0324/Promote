<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="jobList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="cron執行表示式" align="center" prop="cronExpression" :show-overflow-tooltip="true" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="700px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
              ...
              <span slot="label">
                ...
                <el-tooltip placement="top">
                  <div slot="content">
                    ...
                    <br />Class類呼叫示例：com.ruoyi.quartz.task.RyTask.ryParams('ry')
                    <br />引數說明：支援字串，布林型別，長整型，浮點型，整型
                  </div>
          ...
          <el-col :span="12">
            <el-form-item label="cron表示式" prop="cronExpression">
              <el-input v-model="form.cronExpression" placeholder="請輸入cron執行表示式" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
    ...
    <!-- 任務日誌詳細 -->
    <el-dialog title="任務詳細" :visible.sync="openView" width="700px">
      <el-form ref="form" :model="form" label-width="120px" size="mini">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="cron表示式：">{{ form.cronExpression }}</el-form-item>
          </el-col>
          <el-col :span="12">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        cronExpression: [
          { required: true, message: "cron執行表示式不能為空", trigger: "blur" }
        ]
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否確認刪除定時任務編號為"' + jobIds + '"的資料項?', "警告", {
          confirmButtonText: "確定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
    ...
    handleExport() {
      ...
      this.$confirm("是否確認匯出所有定時任務資料項?", "警告", {
          confirmButtonText: "確定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
