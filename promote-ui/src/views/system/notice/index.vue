<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
      ...
      <el-form-item label="型別" prop="noticeType">
        <el-select v-model="queryParams.noticeType" placeholder="公告型別" clearable size="small">
          <el-option
    ...
    <el-table v-loading="loading" :data="noticeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="建立時間" align="center" prop="createTime" width="100">
    ...
    <el-dialog :title="title" :visible.sync="open" width="780px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="公告型別" prop="noticeType">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        noticeType: [
          { required: true, message: "公告型別不能為空", trigger: "blur" }
        ]
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否確認刪除公告編號為"' + noticeIds + '"的資料項?', "警告", {
