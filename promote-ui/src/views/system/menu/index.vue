<template>
  <div class="app-container">
    ...
    >
      <el-table-column prop="menuName" label="選單名稱" :show-overflow-tooltip="true" width="160"></el-table-column>
      ...
      <el-table-column prop="perms" label="許可權標識" :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="component" label="元件路徑" :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="visible" label="可見" :formatter="visibleFormat" width="80"></el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="選單型別" prop="menuType">
          ...
          <el-col :span="24">
            <el-form-item v-if="form.menuType != 'F'" label="選單圖示">
              <el-popover
              ...
              >
                ...
                <el-input slot="reference" v-model="form.icon" placeholder="點選選擇圖示" readonly>
                  <svg-icon
                    v-if="form.icon"
                    slot="prefix"
          ...
          <el-col :span="12">
            <el-form-item v-if="form.menuType != 'M'" label="許可權標識">
              <el-input v-model="form.perms" placeholder="請許可權標識" maxlength="50" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
...
export default {
  ...
  methods: {
    ...
    /** 刪除按鈕操作 */
    handleDelete(row) {
      this.$confirm('是否確認刪除名稱為"' + row.menuName + '"的資料項?', "警告", {
