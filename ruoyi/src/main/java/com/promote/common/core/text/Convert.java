package com.promote.common.core.text;
...
public class Convert
{
    ...
    /**
     * 轉換為boolean<br>
     * String支援的值為：true、false、yes、ok、no，1,0 如果給定的值為空，或者轉換失敗，返回預設值<br>
     * 轉換失敗不會報錯
     * 
     * @param value 被轉換的值
     * @param defaultValue 轉換錯誤時的預設值
    ...
    /**
     * 將物件轉為字串<br>
     * 1、Byte陣列和ByteBuffer會被轉換為對應字串的陣列 2、物件陣列會呼叫Arrays.toString方法
     * 
     * @param obj 物件
     * @return 字串
     */
     ...
     * 
     * @param data 字串
     * @param charset 字符集，如果此欄位為空，則解碼的結果取決於平臺
     * @return 解碼後的字串
     */
    ...
    /**
     * 將編碼的byteBuffer資料轉換為字串
     * 
     * @param data 資料
     * @param charset 字符集，如果為空使用當前系統字符集
     * @return 字串
     */
